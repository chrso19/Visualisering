...
Users can select a specific time period \(\text{stacked bar}\) to access more detailed views, enabling a drill-down from monthly to daily observations.
